...
model = YOLO("/home/chase/shy/dataset/bodyfactor_detect/yolo11.yaml")  # build a new model from YAML
# model = YOLO('/home/chase/shy/dataset/detect_mohu/run/train2/weights/best.pt')  # 加载部分训练的模型
# model = YOLO("yolov8m.pt")  # load a pretrained model (recommended for training)
# model = YOLO("yolov8m.yaml").load("yolov8m.pt")  # build from YAML and transfer weights
with open('/home/chase/shy/dataset/bodyfactor_detect/default.yaml') as f:
